...
public:
    ...
    void setupUi(QMainWindow *ControlWindow)
    {
        ...
        frame_8->setGeometry(QRect(180, 280, 161, 161));
        ...
        frame_9->setGeometry(QRect(10, 450, 231, 71));
        ...
        performancePreresolution->setGeometry(QRect(140, 40, 86, 25));

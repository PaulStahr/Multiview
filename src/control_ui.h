...
public:
    ...
    void setupUi(QMainWindow *ControlWindow)
    {
        ...
        QObject::connect(actionQuit, SIGNAL(triggered()), ControlWindow, SLOT(quit()));
    ...
    void retranslateUi(QMainWindow *ControlWindow)
    {
        ...
        actionMesh->setText(QApplication::translate("ControlWindow", "Mesh", Q_NULLPTR));
        actionAnimation->setText(QApplication::translate("ControlWindow", "Animation", Q_NULLPTR));
        actionFramelist->setText(QApplication::translate("ControlWindow", "Framelist", Q_NULLPTR));
        actionScreenshot->setText(QApplication::translate("ControlWindow", "Screenshot", Q_NULLPTR));
        actionQuit->setText(QApplication::translate("ControlWindow", "Quit", Q_NULLPTR));
        actionCamera->setText(QApplication::translate("ControlWindow", "Camera", Q_NULLPTR));
        ...
        checkBoxCrop->setText(QApplication::translate("ControlWindow", "Crop", Q_NULLPTR));
        ...
        menuFile->setTitle(QApplication::translate("ControlWindow", "Fi&le", Q_NULLPTR));
        menuImport->setTitle(QApplication::translate("ControlWindow", "Add", Q_NULLPTR));
        menuExport->setTitle(QApplication::translate("ControlWindow", "Export", Q_NULLPTR));
        menuScripts->setTitle(QApplication::translate("ControlWindow", "Scripts", Q_NULLPTR));
    } // retranslateUi

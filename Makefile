...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_DEPRECATED_WARNINGS -DOPENEXR -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		Multiview.pro src/control_ui.h \
